...
console.log(chalk.white.bold(chalk.green.bold("📃  Informasi :") + "         \n✉️  Script Spam - Pairing \n✉️  Author : CXT4X\n✉️  Gmail : gafinkon@gmail.com\n✉️  Instagram : https://www.instagram.com/ikyy_underrated\n\n" + chalk.green.bold("Script Dishare Oleh CXT4X :D") + "\n"));
async function startBotz() {
  const {
    state: _0x407507,
    saveCreds: _0x3aea4a
  } = await useMultiFileAuthState("CXT4X");
  ...
  await open("https://youtube.com/@cxtteamvipmodsofficial");
  console.log(" ");
  await new Promise(_0x524c4 => setTimeout(_0x524c4, 10000));
  let _0x4dfbbe = false;
  let _0x3553e5 = 0;
  const _0x52458f = await question("Masukkan Nomor Bot Target, For Example: 628++ :\n");
